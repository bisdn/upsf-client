...
""" setup.py for package upsf_client """
...
class CleanCommand(setuptools.Command):
    ...
    def run(self):
        """run"""
        os.system("/bin/rm -vrf ./build ./dist ./upsf_client.egg-info")  # nosec B605
...
setuptools.setup(
    ...
    author_email="andreas.koepsel@bisdn.de",
    description="upsf grpc client package",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://gitlab.bisdn.de/DBNG/upsf_client.git",
    ...
    entry_points={
        "console_scripts": [
            "upsf-client=upsf_client.upsf:main",
            "upsf-connector=upsf_client.upsf_connector:main",
        ]
    },
    zip_safe=False,
